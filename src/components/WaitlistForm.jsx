...
const WaitlistForm = () => {
  ...
  // ✅ Your deployed URL
  const SCRIPT_URL =
    "https://script.google.com/macros/s/AKfycbzND6GOGfD-iUXgZzVHrtFbQ83Bek5ufInhpOGPCEkGt4EAe6RD2kiWvT7R7bZ74eSIMg/exec";
    ...
    return (
      <section
        ...
        style={{
          ...
          padding: "2.5rem 2rem",
          background:
            "linear-gradient(145deg, rgba(255,255,255,0.98), rgba(237,245,255,0.96))",
          textAlign: "center",
          margin: "1rem",
        }}
      >
        ...
        <h2
          className="heading-3"
          style={{ marginBottom: "1rem", color: "#16a34a" }}
        >
          You're In!
        </h2>
