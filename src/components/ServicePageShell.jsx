...
export default function ServicePageShell({
  ...
  const onSubmit = async (e) => {
    ...
    try {
      await fetch(`${contactScriptUrl}?${queryString}`, {
        method: "GET",
        mode: "no-cors",
      });
      setSent(true);
  ...
  return (
    ...
    >
      ...
      <div
        className="wrapper"
        style={{ position: "relative", zIndex: 1, maxWidth: "72rem" }}
      >
        {/* HERO SECTION */}
        <div style={{ maxWidth: "56rem", marginBottom: "2.0rem" }}>
          ...
          <div style={{ marginTop: "1.8rem" }}>
            <a href={brochureUrl} download style={downloadBtnStyle}>
              Download Brochure
            </a>
          </div>
        </div>
        ...
        <div className="grid-2" style={{ alignItems: "start", gap: "1.5rem" }}>
          <section
            className="card"
            style={{ borderRadius: "1.5rem", padding: "1.9rem" }}
          >
          ...
          >
            ...
            {sent ? (
              <div style={{ textAlign: "center", padding: "1rem" }}>
                ...
                >
                  Request submitted for {form.service}!
                </p>
                <button
