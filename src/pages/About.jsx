    ...
    <div className="wrapper">
      ...
      <div style={{ maxWidth: "60rem", margin: "0 auto", textAlign: "center" }}>
        ...
        <p className="desc" style={{ marginLeft: "auto", marginRight: "auto" }}>
          Zenrax exists to bridge strategy, finance, and technology for founders
          who want disciplined, predictable growth. Every engagement is designed
          to connect high‑level decisions with the day‑to‑day systems your team
          uses.
        </p>
