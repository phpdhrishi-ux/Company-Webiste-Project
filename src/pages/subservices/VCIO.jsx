      ...
      helpGrid={[
        {
          ...
          desc: "Designing a long-term technology plan that supports business growth.",
        },
        {
          title: "Cybersecurity & Risk Mgmt",
          desc: "Establishing robust security protocols and disaster recovery frameworks.",
        },
        {
          title: "Infrastructure Optimization",
          desc: "Evaluating and streamlining hardware, software, and cloud resources.",
        },
        {
          title: "Vendor Management",
          desc: "Managing relationships and SLAs with third-party tech service providers.",
        },
        {
          title: "Technology Budgeting",
          desc: "Aligning IT spend with business value and reducing technical debt.",
        },
        {
          title: "Governance & Compliance",
          desc: "Ensuring IT operations meet regulatory standards and internal policies.",
        },
      ]}
      provides={[
