      ...
      helpGrid={[
        {
          ...
          desc: "Evaluating and enhancing controls for process reliability and accuracy.",
        },
        {
          title: "Operational Audits",
          desc: "Objective review of business processes to identify gaps and inefficiencies.",
        },
        {
          title: "Compliance Reviews",
          desc: "Assessing adherence to laws and policies to reduce regulatory risk.",
        },
        {
          title: "Risk Identification",
          desc: "Designing structured mitigation frameworks aligned with objectives.",
        },
        {
          title: "Audit Readiness",
          desc: "Preparing businesses for statutory audits or investor scrutiny.",
        },
        {
          title: "Management Reporting",
          desc: "Actionable reports highlighting findings and improvement opportunities.",
        },
      ]}
      provides={[
