      ...
      helpGrid={[
        {
          ...
          desc: "Detailed analysis to design system architectures that support future performance.",
        },
        {
          title: "Custom Application Dev",
          desc: "Building tailored applications using modern technologies for security and usability.",
        },
        {
          title: "Testing & Deployment",
          desc: "Comprehensive testing and smooth deployment to ensure application stability.",
        },
        {
          title: "Legacy Modernization",
          desc: "Replacing outdated systems with modern, performance-driven digital solutions.",
        },
        {
          title: "System Architecture",
          desc: "Designing robust backends that scale seamlessly as your user base grows.",
        },
        {
          title: "Ongoing Support",
          desc: "Continuous improvement and technical maintenance after the initial launch.",
        },
      ]}
      provides={[
