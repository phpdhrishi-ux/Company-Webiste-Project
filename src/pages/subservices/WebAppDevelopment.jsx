      ...
      helpGrid={[
        {
          ...
          desc: "Developing powerful web-based tools for internal or external use.",
        },
        {
          title: "Responsive Design",
          desc: "Ensuring your application works perfectly on desktop, tablet, and mobile.",
        },
        {
          title: "API Development",
          desc: "Building secure and fast APIs to connect your web app to other services.",
        },
        {
          title: "E-commerce Solutions",
          desc: "Creating secure, scalable online stores with integrated payments.",
        },
        {
          title: "Performance Tuning",
          desc: "Optimizing code and assets for lightning-fast load times.",
        },
        {
          title: "Maintenance & Hosting",
          desc: "Ongoing web support to keep your application secure and online.",
        },
      ]}
      provides={[
