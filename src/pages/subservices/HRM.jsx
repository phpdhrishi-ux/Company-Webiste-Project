  ...
  return (
    <ServicePageShell
      ...
      helpGrid={[
        ...
        { title: "Contract Staffing", desc: "Flexible workforce solutions for projects and peak workload requirements." },
        { title: "Staff Augmentation", desc: "Scaling teams quickly with pre-vetted professionals for continuity." },
        { title: "Cultural Assessments", desc: "Evaluating fit to ensure long-term retention and team harmony." },
        { title: "Compliance Support", desc: "Managing HR documentation and regulatory alignment for hiring." },
      ]}
      provides={[
