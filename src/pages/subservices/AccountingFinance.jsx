  ...
  return (
    <ServicePageShell
      ...
      helpGrid={[
        ...
        { title: "Financial Analysis", desc: "Transforming data into insights through structured management reports." },
        { title: "Cost & Profitability Analysis", desc: "Identifying cost inefficiencies and analyzing margins by business unit." },
        { title: "Accounting System Setup", desc: "Selecting and optimizing accounting systems for accurate, scalable reporting." },
        { title: "Bookkeeping Services", desc: "Maintaining clean, up-to-date records and reliable accounting data." },
      ]}
      provides={[
