      ...
      helpGrid={[
        {
          ...
          desc: "Analyzing business processes to design solutions aligned with your needs.",
        },
        {
          title: "Custom ERP Development",
          desc: "Configuring systems tailored to specific functional workflows.",
        },
        {
          title: "System Integration",
          desc: "Seamlessly connecting ERP/CRM tools with your existing software ecosystem.",
        },
        {
          title: "Data Migration",
          desc: "Securely migrating historical and operational data to your new platform.",
        },
        {
          title: "Real-time Visibility",
          desc: "Building dashboards for real-time tracking of finance and operations.",
        },
        {
          title: "Support & Optimization",
          desc: "Ongoing tuning to ensure the system evolves with your growth.",
        },
      ]}
      provides={[
