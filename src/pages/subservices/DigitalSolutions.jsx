      ...
      helpGrid={[
        {
          ...
          desc: "Updating internal infrastructures to support modern digital requirements.",
        },
        {
          title: "Mobile App Development",
          desc: "Developing native and cross-platform apps for seamless user experiences.",
        },
        {
          title: "UI/UX Design",
          desc: "Creating user-centric designs that improve engagement and ease of use.",
        },
        {
          title: "Digital Strategy",
          desc: "Aligning your technology roadmap with overall business growth targets.",
        },
        {
          title: "Process Digitization",
          desc: "Moving manual operations into structured, automated digital systems.",
        },
        {
          title: "Backend Integration",
          desc: "Securely connecting your digital platforms with existing business data.",
        },
      ]}
      provides={[
