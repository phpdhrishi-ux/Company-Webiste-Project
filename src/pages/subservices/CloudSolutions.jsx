      ...
      helpGrid={[
        {
          ...
          desc: "Designing applications optimized for resilience, scale, and performance.",
        },
        {
          title: "Cloud Migration",
          desc: "Moving existing systems to the cloud with minimal business disruption.",
        },
        {
          title: "Cost Optimization",
          desc: "Balancing environment performance with operational cost efficiency.",
        },
        {
          title: "Cloud Security",
          desc: "Implementing robust security protocols to protect your data and infra.",
        },
        {
          title: "Scalable Infrastructure",
          desc: "Building systems that grow automatically with your user demand.",
        },
        {
          title: "Modernization",
          desc: "Updating legacy systems to leverage modern cloud-based features.",
        },
      ]}
      provides={[
