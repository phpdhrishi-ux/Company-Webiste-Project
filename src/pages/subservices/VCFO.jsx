      ...
      helpGrid={[
        {
          ...
          desc: "Guiding business strategy with high-level financial oversight and expertise.",
        },
        {
          title: "Cash Flow & Runway Management",
          desc: "Diligent monitoring of cash burn, liquidity, and future funding requirements.",
        },
        {
          title: "Investor Reporting & Relations",
          desc: "Building professional reporting decks and managing stakeholder transparency.",
        },
        {
          title: "Profitability Optimization",
          desc: "Analyzing unit economics and margins to drive sustainable business growth.",
        },
        {
          title: "Budgeting & Financial Planning",
          desc: "Creating robust annual operating plans and dynamic financial forecasts.",
        },
        {
          title: "Audit & Compliance Oversight",
          desc: "Liaising with auditors and ensuring all financial processes meet standards.",
        },
      ]}
      provides={[
